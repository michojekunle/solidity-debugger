...
All notable changes to the "Smart Contract Debugger with Visualized State Changes" extension will be documented in this file.
...
- `Smart Contract Debugger: Show State Visualizer` - Open state visualization panel
- `Smart Contract Debugger: Show Gas Analyzer` - Open gas analysis panel
